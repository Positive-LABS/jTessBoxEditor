...
public class Gui extends javax.swing.JFrame {
    ...
    public Gui() {
        ...
        initComponents();
        jTabbedPaneBoxData.setMnemonicAt(0, KeyEvent.VK_2);
        jTabbedPaneBoxData.setMnemonicAt(2, KeyEvent.VK_3);
    ...
    private void initComponents() {
        ...
        jMenuItemXInc = new javax.swing.JMenuItem();
        jMenuItemXDec = new javax.swing.JMenuItem();
        jMenuItemYInc = new javax.swing.JMenuItem();
        jMenuItemYDec = new javax.swing.JMenuItem();
        jMenuItemWInc = new javax.swing.JMenuItem();
        jMenuItemWDec = new javax.swing.JMenuItem();
        jMenuItemHInc = new javax.swing.JMenuItem();
        jMenuItemHDec = new javax.swing.JMenuItem();
        ...
        jButtonOpen.setMnemonic(KeyEvent.VK_O);
        ...
        jButtonPrev1.setMnemonic(KeyEvent.VK_S);
        jButtonPrev1.setText("Prev");
        jButtonPrev1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonPrev1ActionPerformed(evt);
            }
        });
        jPanelSpinner.add(jButtonPrev1);

        jButtonNext1.setMnemonic(KeyEvent.VK_D);
        ...
        jPanelSpinner.add(jButtonNext1);
...
//                		JOptionPane.showMessageDialog(jTable, "test");
        ...
        jMenuFile.setMnemonic(KeyEvent.VK_0);
        ...
        jMenuItemMerge.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_Z, java.awt.event.InputEvent.ALT_MASK));
        ...
        jMenuItemSplit.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_X, java.awt.event.InputEvent.ALT_MASK));
        ...
        jMenuItemInsert.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_C, java.awt.event.InputEvent.ALT_MASK));
        ...
        jMenuItem2.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_BACK_QUOTE, 0));
        jMenuItem2.setText("Delete Line");
        ...
        jMenuSettings.setMnemonic(KeyEvent.VK_T);
        ...
        jMenuLookAndFeel.setMnemonic(KeyEvent.VK_0);
        ...
        jMenuItemMergeTiff.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_M, java.awt.event.InputEvent.ALT_MASK | java.awt.event.InputEvent.CTRL_MASK));
        ...
        jMenu1.setText("Micro");

        jMenuItemXInc.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_J, java.awt.event.InputEvent.ALT_MASK));
        jMenuItemXInc.setText("X Inc");
        jMenuItemXInc.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemXIncActionPerformed(evt);
            }
        });
        jMenu1.add(jMenuItemXInc);

        jMenuItemXDec.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_H, java.awt.event.InputEvent.ALT_MASK));
        jMenuItemXDec.setText("X Dec");
        jMenuItemXDec.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemXDecActionPerformed(evt);
            }
        });
        jMenu1.add(jMenuItemXDec);

        jMenuItemYInc.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_K, java.awt.event.InputEvent.ALT_MASK));
        jMenuItemYInc.setText("Y Inc");
        jMenuItemYInc.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemYIncActionPerformed(evt);
            }
        });
        jMenu1.add(jMenuItemYInc);

        jMenuItemYDec.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_I, java.awt.event.InputEvent.ALT_MASK));
        jMenuItemYDec.setText("Y Dec");
        jMenuItemYDec.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemYDecActionPerformed(evt);
            }
        });
        jMenu1.add(jMenuItemYDec);

        jMenuItemWInc.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_M, java.awt.event.InputEvent.ALT_MASK));
        jMenuItemWInc.setText("W Inc");
        jMenuItemWInc.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemWIncActionPerformed(evt);
            }
        });
        jMenu1.add(jMenuItemWInc);

        jMenuItemWDec.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_N, java.awt.event.InputEvent.ALT_MASK));
        jMenuItemWDec.setText("W Dec");
        jMenuItemWDec.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemWDecActionPerformed(evt);
            }
        });
        jMenu1.add(jMenuItemWDec);

        jMenuItemHInc.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_COMMA, java.awt.event.InputEvent.ALT_MASK));
        jMenuItemHInc.setText("H Inc");
        jMenuItemHInc.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemHIncActionPerformed(evt);
            }
        });
        jMenu1.add(jMenuItemHInc);

        jMenuItemHDec.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_L, java.awt.event.InputEvent.ALT_MASK));
        jMenuItemHDec.setText("H Dec");
        jMenuItemHDec.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemHDecActionPerformed(evt);
            }
        });
        jMenu1.add(jMenuItemHDec);

        jMenuBar.add(jMenu1);

        jMenuHelp.setMnemonic(KeyEvent.VK_P);
...
//            oome.printStackTrace();
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        jTextFieldCharacter.selectAll();
        jTextFieldCharacter.requestFocus();
    }//GEN-LAST:event_jMenuItem1ActionPerformed

    private void jMenuItemXIncActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemXIncActionPerformed
        int v = Integer.parseInt(jSpinnerX.getValue().toString()) + 1;
        jSpinnerX.setValue(v);
    }//GEN-LAST:event_jMenuItemXIncActionPerformed

    private void jMenuItemXDecActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemXDecActionPerformed
        int v = Integer.parseInt(jSpinnerX.getValue().toString()) - 1 ;
        v = v <0 ? 0 :v;
        jSpinnerX.setValue(v);
    }//GEN-LAST:event_jMenuItemXDecActionPerformed

    private void jMenuItemYIncActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemYIncActionPerformed
        int v = Integer.parseInt(jSpinnerY.getValue().toString()) + 1;
        jSpinnerY.setValue(v);
    }//GEN-LAST:event_jMenuItemYIncActionPerformed

    private void jMenuItemYDecActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemYDecActionPerformed
        int v = Integer.parseInt(jSpinnerY.getValue().toString()) - 1 ;
        v = v <0 ? 0 :v;
        jSpinnerY.setValue(v);
    }//GEN-LAST:event_jMenuItemYDecActionPerformed

    private void jMenuItemWIncActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemWIncActionPerformed
        int v = Integer.parseInt(jSpinnerW.getValue().toString()) + 1;
        jSpinnerW.setValue(v);
    }//GEN-LAST:event_jMenuItemWIncActionPerformed

    private void jMenuItemWDecActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemWDecActionPerformed
        int v = Integer.parseInt(jSpinnerW.getValue().toString()) - 1 ;
        v = v <0 ? 0 :v;
        jSpinnerW.setValue(v);
    }//GEN-LAST:event_jMenuItemWDecActionPerformed

    private void jMenuItemHIncActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemHIncActionPerformed
        int v = Integer.parseInt(jSpinnerH.getValue().toString()) + 1;
        jSpinnerH.setValue(v);
    }//GEN-LAST:event_jMenuItemHIncActionPerformed

    private void jMenuItemHDecActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemHDecActionPerformed
        int v = Integer.parseInt(jSpinnerH.getValue().toString()) - 1 ;
        v = v <0 ? 0 :v;
        jSpinnerH.setValue(v);
    }//GEN-LAST:event_jMenuItemHDecActionPerformed
    void DeleteLineActionPerformed(java.awt.event.ActionEvent evt){
        jMenuItem2ActionPerformed(evt);
    }
    ...
    private javax.swing.JMenuItem jMenuItemHDec;
    private javax.swing.JMenuItem jMenuItemHInc;
    ...
    private javax.swing.JMenuItem jMenuItemWDec;
    private javax.swing.JMenuItem jMenuItemWInc;
    private javax.swing.JMenuItem jMenuItemXDec;
    private javax.swing.JMenuItem jMenuItemXInc;
    private javax.swing.JMenuItem jMenuItemYDec;
    private javax.swing.JMenuItem jMenuItemYInc;
